...
export const auth = betterAuth({
  baseURL: {
    allowedHosts: [
      `${process.env.NEXT_PUBLIC_PROJECT_PRODUCTION_URL}`,
      `www.${process.env.NEXT_PUBLIC_PROJECT_PRODUCTION_URL}`,
  ...
  socialProviders: {
    ...
    spotify: {
      ...
      redirectURI: `https://${process.env.NEXT_PUBLIC_PROJECT_PRODUCTION_URL || process.env.NEXT_PUBLIC_VERCEL_BRANCH_URL || process.env.NEXT_PUBLIC_HOST}/projects/spotify-artist-collage/api/auth/callback/spotify`,
    },
  },
