import { createContext, useContext, useState, useEffect } from "react"; // createContext is an object
...
export const UserProvider = ({ children }: UserProviderProps) => {
  // UserProvider can be part of UserContext component
  const [user, setUser] = useState<User | null>(null); // Sets state of user. Meaning of useState<T>?
